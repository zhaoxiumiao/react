...
function Header (props) {
    ...
    const {focused,totalPage, handleInputFocus, handleInputBlur, list, page, handleMouseEnter, handleMouseLeave, mouseIn, handleChangePage} = props
